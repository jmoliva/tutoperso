...
On récupère l'image docker de la dernière version de VTiger 7.0.1 sur DockerHub <a href="https://hub.docker.com/r/ldavid/vtiger7/" target="_blank">https://hub.docker.com/r/ldavid/vtiger7/</a>
```
